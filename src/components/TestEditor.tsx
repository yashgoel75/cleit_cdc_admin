  ...
  useEffect(() => {
    if (editorRef.current && !quillInstance.current) {
      ...
      if (containerRef.current) {
        const existingToolbars = containerRef.current.querySelectorAll('.ql-toolbar');
        existingToolbars.forEach(toolbar => toolbar.remove());
      }

      quillInstance.current = new Quill(editorRef.current, {
        theme: "snow",
        placeholder: "Write your test description here... Include instructions, topics covered, grading criteria, and any special notes for students.",
        modules: {
          toolbar: [
